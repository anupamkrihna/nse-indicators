...
function doGet(e) {
  ...
  try {
    ...
    else if (a === 'health') out = routeHealth_();         // unified weekly calibration/health snapshot (Health.gs)
...
/* UNIVERSE v6 — 799 names · built 2026-07-24
   = v5 (798) + PFOCUS (Prime Focus, sole new Nifty Total Market straggler).
   MILESTONE: the clean index-CSV path is exhausted — Nifty Total Market
   (743 EQ) was 742/743 already covered. 799 names span essentially the
   entire liquid, index-tracked NSE mainboard. Further growth requires
   sub-index sources (SME / turnover-ranked full EQ), deferred by choice.
   Roster model: fixed healthy set; ugAuditUniverse() flags DEAD/PROBLEM
   names for replacement. */
var UNIVERSE =
'360ONE|360 ONE WAM|Financial Services|360ONE.NS\n' +
'3MINDIA|3M India|Diversified|3MINDIA.NS\n' +
'AADHARHFC|Aadhar Housing Finance|Financial Services|AADHARHFC.NS\n' +
'AARTIDRUGS|Aarti Drugs|Healthcare|AARTIDRUGS.NS\n' +
'AARTIIND|Aarti Industries|Chemicals|AARTIIND.NS\n' +
'AARTIPHARM|Aarti Pharmalabs|Healthcare|AARTIPHARM.NS\n' +
'AAVAS|Aavas Financiers|Financial Services|AAVAS.NS\n' +
...
'ABDL|Allied Blenders and Distillers|FMCG|ABDL.NS\n' +
'ABFRL|Aditya Birla Fashion|Retail|ABFRL.NS\n' +
'ABLBL|Aditya Birla Lifestyle Brands|Consumer Services|ABLBL.NS\n' +
'ABREL|Aditya Birla Real Estate|Realty|ABREL.NS\n' +
'ABSLAMC|Aditya Birla Sun Life AMC|Financial Services|ABSLAMC.NS\n' +
'ACC|ACC|Construction Materials|ACC.NS\n' +
'ACE|Action Construction Equipment|Capital Goods|ACE.NS\n' +
'ACI|Archean Chemical Industries|Chemicals|ACI.NS\n' +
'ACMESOLAR|ACME Solar Holdings|Power|ACMESOLAR.NS\n' +
'ACUTAAS|Acutaas Chemicals|Healthcare|ACUTAAS.NS\n' +
'ADANIENSOL|Adani Energy Solutions|Power|ADANIENSOL.NS\n' +
...
'ADVENZYMES|Advanced Enzyme Tech|Healthcare|ADVENZYMES.NS\n' +
'AEGISLOG|Aegis Logistics|Oil Gas & Consumable Fuels|AEGISLOG.NS\n' +
'AEGISVOPAK|Aegis Vopak Terminals|Oil Gas & Consumable Fuels|AEGISVOPAK.NS\n' +
'AEQUS|Aequs|Capital Goods|AEQUS.NS\n' +
'AETHER|Aether Industries|Chemicals|AETHER.NS\n' +
'AFCONS|Afcons Infrastructure|Construction|AFCONS.NS\n' +
'AFFLE|Affle India|Ad Tech|AFFLE.NS\n' +
'AGARWALEYE|Dr. Agarwal\'s Health Care|Healthcare|AGARWALEYE.NS\n' +
'AHLUCONT|Ahluwalia Contracts (India)|Construction|AHLUCONT.NS\n' +
'AIAENG|AIA Engineering|Industrial|AIAENG.NS\n' +
'AIIL|Authum Investment & Infrastructure|Financial Services|AIIL.NS\n' +
'AJANTPHARM|Ajanta Pharma|Pharma|AJANTPHARM.NS\n' +
'AKUMS|Akums Drugs and Pharmaceuticals|Healthcare|AKUMS.NS\n' +
'ALIVUS|Alivus Life Sciences|Healthcare|ALIVUS.NS\n' +
'ALKEM|Alkem Laboratories|Pharma|ALKEM.NS\n' +
'ALKYLAMINE|Alkyl Amines Chemicals|Chemicals|ALKYLAMINE.NS\n' +
'ALOKINDS|Alok Industries|Textile|ALOKINDS.NS\n' +
'AMBER|Amber Enterprises|Electronics|AMBER.NS\n' +
'AMBUJACEM|Ambuja Cements|Cement|AMBUJACEM.NS\n' +
'ANANDRATHI|Anand Rathi Wealth|Financial Services|ANANDRATHI.NS\n' +
'ANANTRAJ|Anant Raj|Realty|ANANTRAJ.NS\n' +
'ANGELONE|Angel One|Financial Services|ANGELONE.NS\n' +
'ANTHEM|Anthem Biosciences|Healthcare|ANTHEM.NS\n' +
'ANUP|The Anup Engineering|Capital Goods|ANUP.NS\n' +
'ANURAS|Anupam Rasayan India|Chemicals|ANURAS.NS\n' +
'APARINDS|Apar Industries|Electrical|APARINDS.NS\n' +
'APLAPOLLO|APL Apollo Tubes|Metal|APLAPOLLO.NS\n' +
'APLLTD|Alembic Pharmaceuticals|Healthcare|APLLTD.NS\n' +
'APOLLO|Apollo Micro Systems|Defence|APOLLO.NS\n' +
...
'ARE&M|Amara Raja Energy & Mobility|Automobile & Auto Components|ARE&M.NS\n' +
'ARVIND|Arvind|Textiles|ARVIND.NS\n' +
'ARVINDFASN|Arvind Fashions|Consumer Services|ARVINDFASN.NS\n' +
'ASAHIINDIA|Asahi India Glass|Auto Ancillary|ASAHIINDIA.NS\n' +
'ASHAPURMIN|Ashapura Minechem|Metals & Mining|ASHAPURMIN.NS\n' +
...
'ASKAUTOLTD|ASK Automotive|Automobile & Auto Components|ASKAUTOLTD.NS\n' +
'ASTERDM|Aster DM Healthcare|Healthcare|ASTERDM.NS\n' +
...
'ATHERENERG|Ather Energy|Automobile & Auto Components|ATHERENERG.NS\n' +
'ATLANTAELE|Atlanta Electricals|Capital Goods|ATLANTAELE.NS\n' +
'ATUL|Atul|Chemicals|ATUL.NS\n' +
'AUBANK|AU Small Finance Bank|Banking|AUBANK.NS\n' +
'AURIONPRO|Aurionpro Solutions|Information Technology|AURIONPRO.NS\n' +
'AUROPHARMA|Aurobindo Pharma|Pharma|AUROPHARMA.NS\n' +
'AVALON|Avalon Technologies|Capital Goods|AVALON.NS\n' +
'AVANTIFEED|Avanti Feeds|Aquaculture|AVANTIFEED.NS\n' +
'AVL|Aditya Vision|Consumer Services|AVL.NS\n' +
'AWFIS|Awfis Space Solutions|Services|AWFIS.NS\n' +
'AWL|AWL Agri Business|FMCG|AWL.NS\n' +
'AXISBANK|Axis Bank|Banking|AXISBANK.NS\n' +
'AXISCADES|AXISCADES Technologies|Capital Goods|AXISCADES.NS\n' +
'AZAD|Azad Engineering|Capital Goods|AZAD.NS\n' +
'BAJAJ-AUTO|Bajaj Auto|Auto|BAJAJ-AUTO.NS\n' +
'BAJAJELEC|Bajaj Electricals|Consumer Durables|BAJAJELEC.NS\n' +
'BAJAJFINSV|Bajaj Finserv|Financial Services|BAJAJFINSV.NS\n' +
'BAJAJHFL|Bajaj Housing Finance|Housing Finance|BAJAJHFL.NS\n' +
'BAJAJHLDNG|Bajaj Holdings & Investment|Financial Services|BAJAJHLDNG.NS\n' +
'BAJFINANCE|Bajaj Finance|NBFC|BAJFINANCE.NS\n' +
'BALAMINES|Balaji Amines|Chemicals|BALAMINES.NS\n' +
'BALKRISIND|Balkrishna Industries|Automobile & Auto Components|BALKRISIND.NS\n' +
'BALRAMCHIN|Balrampur Chini|Sugar|BALRAMCHIN.NS\n' +
'BALUFORGE|Balu Forge Industries|Capital Goods|BALUFORGE.NS\n' +
'BANCOINDIA|Banco Products (India)|Automobile & Auto Components|BANCOINDIA.NS\n' +
'BANDHANBNK|Bandhan Bank|Banking|BANDHANBNK.NS\n' +
'BANKBARODA|Bank of Baroda|Banking/PSU|BANKBARODA.NS\n' +
'BANKINDIA|Bank of India|Financial Services|BANKINDIA.NS\n' +
'BATAINDIA|Bata India|Consumer|BATAINDIA.NS\n' +
'BAYERCROP|Bayer Cropscience|Chemicals|BAYERCROP.NS\n' +
'BBOX|Black Box|Information Technology|BBOX.NS\n' +
'BBTC|Bombay Burmah Trading Corporation|FMCG|BBTC.NS\n' +
'BDL|Bharat Dynamics|Defence|BDL.NS\n' +
'BECTORFOOD|Mrs. Bectors Food Specialities|FMCG|BECTORFOOD.NS\n' +
'BEL|Bharat Electronics|Defence|BEL.NS\n' +
'BELRISE|Belrise Industries|Automobile & Auto Components|BELRISE.NS\n' +
...
'BHARTIHEXA|Bharti Hexacom|Telecommunication|BHARTIHEXA.NS\n' +
'BHEL|Bharat Heavy Electricals|Power/Defence|BHEL.NS\n' +
'BIKAJI|Bikaji Foods|FMCG|BIKAJI.NS\n' +
'BIOCON|Biocon|Pharma|BIOCON.NS\n' +
'BIRLACORPN|Birla Corporation|Construction Materials|BIRLACORPN.NS\n' +
'BLACKBUCK|Blackbuck|Services|BLACKBUCK.NS\n' +
'BLS|BLS International Services|Consumer Services|BLS.NS\n' +
'BLUEDART|Blue Dart Express|Services|BLUEDART.NS\n' +
'BLUEJET|Blue Jet Healthcare|Healthcare|BLUEJET.NS\n' +
'BLUESTARCO|Blue Star|Consumer Durables|BLUESTARCO.NS\n' +
'BLUESTONE|BlueStone Jewellery and Lifestyle|Consumer Durables|BLUESTONE.NS\n' +
'BOROLTD|Borosil|Consumer|BOROLTD.NS\n' +
'BORORENEW|Borosil Renewables|Capital Goods|BORORENEW.NS\n' +
...
'BSOFT|Birlasoft|IT|BSOFT.NS\n' +
'CAMPUS|Campus Activewear|Consumer Durables|CAMPUS.NS\n' +
...
'CANHLIFE|Canara HSBC Life Insurance Company|Financial Services|CANHLIFE.NS\n' +
'CANTABIL|Cantabil Retail India|Retail|CANTABIL.NS\n' +
'CAPILLARY|Capillary Technologies India|Information Technology|CAPILLARY.NS\n' +
'CAPLIPOINT|Caplin Point Laboratories|Healthcare|CAPLIPOINT.NS\n' +
...
'CCAVENUE|AvenuesAI|Financial Services|CCAVENUE.NS\n' +
'CCL|CCL Products India|FMCG|CCL.NS\n' +
'CDSL|CDSL|Financial Services|CDSL.NS\n' +
'CEATLTD|CEAT|Auto Ancillary|CEATLTD.NS\n' +
'CELLO|Cello World|Consumer Durables|CELLO.NS\n' +
'CEMPRO|Cemindia Projects|Construction|CEMPRO.NS\n' +
...
'CGCL|Capri Global Capital|Financial Services|CGCL.NS\n' +
...
'CHENNPETRO|Chennai Petroleum Corporation|Oil Gas & Consumable Fuels|CHENNPETRO.NS\n' +
'CHOICEIN|Choice International|Financial Services|CHOICEIN.NS\n' +
'CHOLAFIN|Cholamandalam Investment|NBFC|CHOLAFIN.NS\n' +
'CHOLAHLDNG|Cholamandalam Financial Holdings|Financial Services|CHOLAHLDNG.NS\n' +
'CIEINDIA|CIE Automotive India|Automobile & Auto Components|CIEINDIA.NS\n' +
'CIPLA|Cipla|Pharma|CIPLA.NS\n' +
'CLEAN|Clean Science Technology|Chemicals|CLEAN.NS\n' +
'CMSINFO|CMS Info Systems|Services|CMSINFO.NS\n' +
'COALINDIA|Coal India|Mining|COALINDIA.NS\n' +
'COCHINSHIP|Cochin Shipyard|Defence|COCHINSHIP.NS\n' +
'COFORGE|Coforge|IT|COFORGE.NS\n' +
'COHANCE|Cohance Lifesciences|Healthcare|COHANCE.NS\n' +
...
'CONCORDBIO|Concord Biotech|Healthcare|CONCORDBIO.NS\n' +
'COROMANDEL|Coromandel International|Chemicals|COROMANDEL.NS\n' +
'CORONA|Corona Remedies|Healthcare|CORONA.NS\n' +
'CPPLUS|Aditya Infotech|Capital Goods|CPPLUS.NS\n' +
'CRAFTSMAN|Craftsman Automation|Automobile & Auto Components|CRAFTSMAN.NS\n' +
'CRAMC|Canara Robeco Asset Management Company|Financial Services|CRAMC.NS\n' +
'CREDITACC|CreditAccess Grameen|Financial Services|CREDITACC.NS\n' +
'CRISIL|CRISIL|Financial Services|CRISIL.NS\n' +
'CRIZAC|Crizac|Consumer Services|CRIZAC.NS\n' +
...
'DEVYANI|Devyani International|Consumer Services|DEVYANI.NS\n' +
'DIACABS|Diamond Power Infrastructure|Capital Goods|DIACABS.NS\n' +
...
'DOMS|DOMS Industries|FMCG|DOMS.NS\n' +
'DRREDDY|Dr. Reddy\'s Laboratories|Pharma|DRREDDY.NS\n' +
'DYNAMATECH|Dynamatic Technologies|Capital Goods|DYNAMATECH.NS\n' +
'ECLERX|eClerx Services|Services|ECLERX.NS\n' +
'EDELWEISS|Edelweiss Financial|Financial Services|EDELWEISS.NS\n' +
'EICHERMOT|Eicher Motors|Auto|EICHERMOT.NS\n' +
'EIDPARRY|E.I.D. Parry (India)|FMCG|EIDPARRY.NS\n' +
'EIEL|Enviro Infra Engineers|Utilities|EIEL.NS\n' +
'EIHOTEL|EIH|Consumer Services|EIHOTEL.NS\n' +
'ELECON|Elecon Engineering Co.|Capital Goods|ELECON.NS\n' +
'ELECTCAST|Electrosteel Castings|Capital Goods|ELECTCAST.NS\n' +
'ELGIEQUIP|Elgi Equipments|Industrial|ELGIEQUIP.NS\n' +
'ELLEN|Ellenbarrie Industrial Gases|Chemicals|ELLEN.NS\n' +
'EMAMILTD|Emami|FMCG|EMAMILTD.NS\n' +
'EMBDL|Embassy Developments|Realty|EMBDL.NS\n' +
'EMCURE|Emcure Pharmaceuticals|Pharma|EMCURE.NS\n' +
'EMIL|Electronics Mart India|Consumer Services|EMIL.NS\n' +
'EMMVEE|Emmvee Photovoltaic Power|Capital Goods|EMMVEE.NS\n' +
...
'ENRIN|Siemens Energy India|Capital Goods|ENRIN.NS\n' +
'ENTERO|Entero Healthcare Solutions|Consumer Services|ENTERO.NS\n' +
'EPL|EPL|Capital Goods|EPL.NS\n' +
'EQUITASBNK|Equitas Small Finance Bank|Banking|EQUITASBNK.NS\n' +
'ERIS|Eris Lifesciences|Healthcare|ERIS.NS\n' +
'ESABINDIA|ESAB India|Industrial|ESABINDIA.NS\n' +
'ESCORTS|Escorts Kubota|Farm Equipment|ESCORTS.NS\n' +
'ETERNAL|Eternal|Consumer Services|ETERNAL.NS\n' +
'ETHOSLTD|Ethos|Consumer Durables|ETHOSLTD.NS\n' +
'EUREKAFORB|Eureka Forbes|Consumer Durables|EUREKAFORB.NS\n' +
'EXIDEIND|Exide Industries|Auto Ancillary|EXIDEIND.NS\n' +
'FACT|Fertilisers and Chemicals Travancore|Chemicals|FACT.NS\n' +
'FEDERALBNK|Federal Bank|Banking|FEDERALBNK.NS\n' +
'FEDFINA|Fedbank Financial Services|Financial Services|FEDFINA.NS\n' +
'FIEMIND|Fiem Industries|Automobile & Auto Components|FIEMIND.NS\n' +
'FINCABLES|Finolex Cables|Electrical|FINCABLES.NS\n' +
'FINEORG|Fine Organic Industries|Chemicals|FINEORG.NS\n' +
'FINPIPE|Finolex Industries|Capital Goods|FINPIPE.NS\n' +
'FIRSTCRY|Brainbees Solutions|Consumer Services|FIRSTCRY.NS\n' +
'FIVESTAR|Five-Star Business Finance|NBFC|FIVESTAR.NS\n' +
'FLUOROCHEM|Gujarat Fluorochemicals|Chemicals|FLUOROCHEM.NS\n' +
'FORCEMOT|Force Motors|Automobile & Auto Components|FORCEMOT.NS\n' +
'FORTIS|Fortis Healthcare|Healthcare|FORTIS.NS\n' +
'FSL|Firstsource Solutions|Services|FSL.NS\n' +
'GABRIEL|Gabriel India|Automobile & Auto Components|GABRIEL.NS\n' +
...
'GHCL|GHCL|Chemicals|GHCL.NS\n' +
'GICRE|General Insurance Corp|Insurance|GICRE.NS\n' +
'GILLETTE|Gillette India|FMCG|GILLETTE.NS\n' +
...
'GMDCLTD|Gujarat Mineral Development Corporation|Metals & Mining|GMDCLTD.NS\n' +
'GMMPFAUDLR|GMM Pfaudler|Capital Goods|GMMPFAUDLR.NS\n' +
'GMRAIRPORT|GMR Airports|Services|GMRAIRPORT.NS\n' +
'GMRP&UI|GMR Power and Urban Infra|Power|GMRP&UI.NS\n' +
'GNFC|GNFC|Chemicals|GNFC.NS\n' +
'GODFRYPHLP|Godfrey Phillips India|FMCG|GODFRYPHLP.NS\n' +
'GODIGIT|Go Digit General Insurance|Financial Services|GODIGIT.NS\n' +
'GODREJAGRO|Godrej Agrovet|FMCG|GODREJAGRO.NS\n' +
...
'GOKEX|Gokaldas Exports|Textiles|GOKEX.NS\n' +
'GOKULAGRO|Gokul Agro Resources|FMCG|GOKULAGRO.NS\n' +
'GPIL|Godawari Power & Ispat|Capital Goods|GPIL.NS\n' +
'GPPL|Gujarat Pipavav Port|Logistics|GPPL.NS\n' +
'GRANULES|Granules India|Healthcare|GRANULES.NS\n' +
'GRAPHITE|Graphite India|Metal|GRAPHITE.NS\n' +
'GRASIM|Grasim Industries|Diversified|GRASIM.NS\n' +
'GRAVITA|Gravita India|Metals & Mining|GRAVITA.NS\n' +
'GREAVESCOT|Greaves Cotton|Capital Goods|GREAVESCOT.NS\n' +
'GRINDWELL|Grindwell Norton|Industrial|GRINDWELL.NS\n' +
'GROWW|Billionbrains Garage Ventures|Financial Services|GROWW.NS\n' +
'GRSE|Garden Reach Shipbuilders|Defence|GRSE.NS\n' +
'GRWRHITECH|Garware Hi-Tech Films|Capital Goods|GRWRHITECH.NS\n' +
'GSFC|Gujarat State Fertilizers & Chemicals|Chemicals|GSFC.NS\n' +
'GUJENERGY|Gujarat Energy|Gas Distribution|GUJENERGY.NS\n' +
'GVT&D|GE Vernova T&D India|Capital Goods|GVT&D.NS\n' +
...
'HBLENGINE|HBL Engineering|Capital Goods|HBLENGINE.NS\n' +
'HCC|Hindustan Construction Co.|Construction|HCC.NS\n' +
'HCG|Healthcare Global Enterprises|Healthcare|HCG.NS\n' +
'HCLTECH|HCL Technologies|IT|HCLTECH.NS\n' +
'HDBFS|HDB Financial Services|Financial Services|HDBFS.NS\n' +
...
'HEMIPROP|Hemisphere Properties India|Services|HEMIPROP.NS\n' +
'HERITGFOOD|Heritage Foods|FMCG|HERITGFOOD.NS\n' +
'HEROMOTOCO|Hero MotoCorp|Auto|HEROMOTOCO.NS\n' +
'HEXT|Hexaware Technologies|IT|HEXT.NS\n' +
'HFCL|HFCL|Telecom|HFCL.NS\n' +
'HGINFRA|H.G. Infra Engineering|Construction|HGINFRA.NS\n' +
...
'HINDZINC|Hindustan Zinc|Metals & Mining|HINDZINC.NS\n' +
'HOMEFIRST|Home First Finance Company India|Financial Services|HOMEFIRST.NS\n' +
'HONASA|Honasa Consumer|FMCG|HONASA.NS\n' +
'HONAUT|Honeywell Automation India|Capital Goods|HONAUT.NS\n' +
'HSCL|Himadri Speciality Chemical|Chemicals|HSCL.NS\n' +
'HUDCO|HUDCO|NBFC/PSU|HUDCO.NS\n' +
'HYUNDAI|Hyundai Motor India|Automobile & Auto Components|HYUNDAI.NS\n' +
'ICICIAMC|ICICI Prudential Asset Management Company|Financial Services|ICICIAMC.NS\n' +
'ICICIBANK|ICICI Bank|Banking|ICICIBANK.NS\n' +
'ICICIGI|ICICI Lombard General Insurance Company|Financial Services|ICICIGI.NS\n' +
'ICICIPRULI|ICICI Prudential Life|Insurance|ICICIPRULI.NS\n' +
'ICIL|Indo Count Industries|Textiles|ICIL.NS\n' +
'IDBI|IDBI Bank|Financial Services|IDBI.NS\n' +
'IDEA|Vodafone Idea|Telecommunication|IDEA.NS\n' +
...
'IFCI|IFCI|Financial Services|IFCI.NS\n' +
'IGIL|International Gemological Institute|Services|IGIL.NS\n' +
'IGL|Indraprastha Gas|Gas Distribution|IGL.NS\n' +
'IGPL|IG Petrochemicals|Chemicals|IGPL.NS\n' +
'IIFL|IIFL Finance|NBFC|IIFL.NS\n' +
'IIFLCAPS|IIFL Capital Services|Financial Services|IIFLCAPS.NS\n' +
'IKS|Inventurus Knowledge Solutions|IT|IKS.NS\n' +
'IMFA|Indian Metals & Ferro Alloys|Metals & Mining|IMFA.NS\n' +
'INDGN|Indegene|Healthcare|INDGN.NS\n' +
'INDHOTEL|Indian Hotels Company|Hospitality|INDHOTEL.NS\n' +
'INDIACEM|India Cements|Construction Materials|INDIACEM.NS\n' +
'INDIAGLYCO|India Glycols|FMCG|INDIAGLYCO.NS\n' +
'INDIAMART|IndiaMart InterMesh|Internet|INDIAMART.NS\n' +
'INDIANB|Indian Bank|Banking/PSU|INDIANB.NS\n' +
'INDIASHLTR|India Shelter Finance Corporation|Financial Services|INDIASHLTR.NS\n' +
...
'INOXINDIA|INOX India|Capital Goods|INOXINDIA.NS\n' +
'INOXWIND|Inox Wind|Capital Goods|INOXWIND.NS\n' +
...
'IONEXCHANG|Ion Exchange India|Chemicals|IONEXCHANG.NS\n' +
'IPCALAB|IPCA Laboratories|Pharma|IPCALAB.NS\n' +
'IRB|IRB Infrastructure Developers|Construction|IRB.NS\n' +
...
'ITC|ITC|FMCG|ITC.NS\n' +
'ITCHOTELS|ITC Hotels|Consumer Services|ITCHOTELS.NS\n' +
'ITI|ITI|Telecommunication|ITI.NS\n' +
'IXIGO|Le Travenues Technology|Consumer Services|IXIGO.NS\n' +
'J&KBANK|Jammu & Kashmir Bank|Financial Services|J&KBANK.NS\n' +
'JAINREC|Jain Resource Recycling|Metals & Mining|JAINREC.NS\n' +
'JAMNAAUTO|Jamna Auto Industries|Automobile & Auto Components|JAMNAAUTO.NS\n' +
'JAYNECOIND|Jayaswal Neco Industries|Capital Goods|JAYNECOIND.NS\n' +
'JBCHEPHARM|J.B. Chemicals & Pharmaceuticals|Healthcare|JBCHEPHARM.NS\n' +
'JBMA|JBM Auto|Automobile & Auto Components|JBMA.NS\n' +
'JINDALSAW|Jindal Saw|Capital Goods|JINDALSAW.NS\n' +
'JINDALSTEL|Jindal Steel & Power|Metal|JINDALSTEL.NS\n' +
'JIOFIN|Jio Financial Services|Financial Services|JIOFIN.NS\n' +
'JKCEMENT|JK Cement|Cement|JKCEMENT.NS\n' +
'JKLAKSHMI|JK Lakshmi Cement|Construction Materials|JKLAKSHMI.NS\n' +
'JKPAPER|JK Paper|Forest Materials|JKPAPER.NS\n' +
'JKTYRE|JK Tyre & Industries|Automobile & Auto Components|JKTYRE.NS\n' +
'JLHL|Jupiter Life Line Hospitals|Healthcare|JLHL.NS\n' +
'JMFINANCIL|JM Financial|Financial Services|JMFINANCIL.NS\n' +
'JPPOWER|Jaiprakash Power Ventures|Power|JPPOWER.NS\n' +
'JSFB|Jana Small Finance Bank|Financial Services|JSFB.NS\n' +
'JSL|Jindal Stainless|Metal|JSL.NS\n' +
'JSLL|Jeena Sikho Lifecare|Consumer Services|JSLL.NS\n' +
'JSWCEMENT|JSW Cement|Construction Materials|JSWCEMENT.NS\n' +
'JSWDULUX|JSW Dulux|Consumer Durables|JSWDULUX.NS\n' +
'JSWENERGY|JSW Energy|Power|JSWENERGY.NS\n' +
'JSWINFRA|JSW Infrastructure|Services|JSWINFRA.NS\n' +
...
'JUBLPHARMA|Jubilant Pharmova|Healthcare|JUBLPHARMA.NS\n' +
'JUSTDIAL|Just Dial|Internet|JUSTDIAL.NS\n' +
'JWL|Jupiter Wagons|Capital Goods|JWL.NS\n' +
'JYOTHYLAB|Jyothy Labs|FMCG|JYOTHYLAB.NS\n' +
'JYOTICNC|Jyoti CNC Automation|Capital Goods|JYOTICNC.NS\n' +
...
'KARURVYSYA|Karur Vysya Bank|Financial Services|KARURVYSYA.NS\n' +
'KAYNES|Kaynes Technology|Electronics|KAYNES.NS\n' +
'KEC|Kec International|Construction|KEC.NS\n' +
'KEI|KEI Industries|Electrical|KEI.NS\n' +
'KFINTECH|Kfin Technologies|Financial Services|KFINTECH.NS\n' +
'KIMS|KIMS|Healthcare|KIMS.NS\n' +
'KIRLOSBROS|Kirloskar Brothers|Capital Goods|KIRLOSBROS.NS\n' +
'KIRLOSENG|Kirloskar Oil Engines|Industrial Machinery|KIRLOSENG.NS\n' +
'KIRLPNU|Kirloskar Pneumatic Company|Capital Goods|KIRLPNU.NS\n' +
'KITEX|Kitex Garments|Textiles|KITEX.NS\n' +
...
'KPIGREEN|KPI Green Energy|Power|KPIGREEN.NS\n' +
'KPIL|Kalpataru Projects International|Construction|KPIL.NS\n' +
'KPITTECH|KPIT Technologies|IT|KPITTECH.NS\n' +
'KPRMILL|K.P.R. Mill|Textiles|KPRMILL.NS\n' +
'KRBL|KRBL (India Gate Rice)|FMCG|KRBL.NS\n' +
'KSB|KSB|Capital Goods|KSB.NS\n' +
'KSCL|Kaveri Seed Company|Agri|KSCL.NS\n' +
'KTKBANK|Karnataka Bank|Financial Services|KTKBANK.NS\n' +
...
'LEMONTREE|Lemon Tree Hotels|Consumer Services|LEMONTREE.NS\n' +
'LENSKART|Lenskart Solutions|Consumer Services|LENSKART.NS\n' +
'LGEINDIA|LG Electronics India|Consumer Durables|LGEINDIA.NS\n' +
...
'LLOYDSENGG|Lloyds Engineering Works|Capital Goods|LLOYDSENGG.NS\n' +
'LLOYDSENT|Lloyds Enterprises|Metals & Mining|LLOYDSENT.NS\n' +
'LLOYDSME|Lloyds Metals & Energy|Metal|LLOYDSME.NS\n' +
'LMW|LMW (Lakshmi Machine Works)|Industrial|LMW.NS\n' +
'LODHA|Lodha Developers|Realty|LODHA.NS\n' +
'LOTUSDEV|Sri Lotus Developers and Realty|Realty|LOTUSDEV.NS\n' +
'LT|Larsen & Toubro|Infrastructure|LT.NS\n' +
'LTF|L&T Finance|Financial Services|LTF.NS\n' +
'LTFOODS|LT Foods|FMCG|LTFOODS.NS\n' +
'LTM|LTIMindtree (LTM)|IT|LTM.NS\n' +
'LTTS|L&T Technology Services|IT|LTTS.NS\n' +
'LUMAXTECH|Lumax Auto Technologies|Automobile & Auto Components|LUMAXTECH.NS\n' +
'LUPIN|Lupin|Pharma|LUPIN.NS\n' +
'LXCHEM|Laxmi Organic Industries|Chemicals|LXCHEM.NS\n' +
'M&M|Mahindra & Mahindra|Auto|M&M.NS\n' +
'M&MFIN|Mahindra & Mahindra Financial Services|Financial Services|M&MFIN.NS\n' +
...
'MANORAMA|Manorama Industries|FMCG|MANORAMA.NS\n' +
'MANYAVAR|Vedant Fashions|Consumer Services|MANYAVAR.NS\n' +
'MAPMYINDIA|C.E. Info Systems|IT|MAPMYINDIA.NS\n' +
'MARICO|Marico|FMCG|MARICO.NS\n' +
'MARKSANS|Marksans Pharma|Healthcare|MARKSANS.NS\n' +
...
'MAZDOCK|Mazagon Dock Shipbuilders|Defence|MAZDOCK.NS\n' +
...
'MEESHO|Meesho|Consumer Services|MEESHO.NS\n' +
...
'MINDACORP|Minda Corporation|Automobile & Auto Components|MINDACORP.NS\n' +
...
'MOTILALOFS|Motilal Oswal Financial Services|Financial Services|MOTILALOFS.NS\n' +
'MPHASIS|Mphasis|IT|MPHASIS.NS\n' +
'MRF|MRF|Automobile & Auto Components|MRF.NS\n' +
'MRPL|Mangalore Refinery & Petrochemicals|Oil Gas & Consumable Fuels|MRPL.NS\n' +
'MSTCLTD|MSTC|Services|MSTCLTD.NS\n' +
'MSUMI|Motherson Sumi Wiring India|Automobile & Auto Components|MSUMI.NS\n' +
'MTARTECH|MTAR Technologies|Defence/Space|MTARTECH.NS\n' +
...
'NAM-INDIA|Nippon Life India Asset Management|Financial Services|NAM-INDIA.NS\n' +
...
'NAVA|Nava|Power|NAVA.NS\n' +
'NAVINFLUOR|Navin Fluorine|Chemicals|NAVINFLUOR.NS\n' +
'NAVNETEDUL|Navneet Education|Education|NAVNETEDUL.NS\n' +
'NAZARA|Nazara Technologies|Media Entertainment & Publication|NAZARA.NS\n' +
'NBCC|NBCC (India)|Construction|NBCC.NS\n' +
'NCC|NCC|Infrastructure|NCC.NS\n' +
'NEOGEN|Neogen Chemicals|Chemicals|NEOGEN.NS\n' +
'NESCO|NESCO|Exhibitions|NESCO.NS\n' +
'NESTLEIND|Nestle India|FMCG|NESTLEIND.NS\n' +
'NETWEB|Netweb Technologies India|IT|NETWEB.NS\n' +
'NETWORK18|Network18 Media|Media|NETWORK18.NS\n' +
'NEULANDLAB|Neuland Laboratories|Healthcare|NEULANDLAB.NS\n' +
'NEWGEN|Newgen Software Technologies|IT|NEWGEN.NS\n' +
'NFL|National Fertilizers|Chemicals|NFL.NS\n' +
'NH|Narayana Hrudayalaya|Healthcare|NH.NS\n' +
'NHPC|NHPC|Power/PSU|NHPC.NS\n' +
'NIACL|New India Assurance|Insurance/PSU|NIACL.NS\n' +
'NIVABUPA|Niva Bupa Health Insurance Company|Financial Services|NIVABUPA.NS\n' +
'NLCINDIA|NLC India|Power/PSU|NLCINDIA.NS\n' +
'NMDC|NMDC|Mining/PSU|NMDC.NS\n' +
'NOCIL|NOCIL|Chemicals|NOCIL.NS\n' +
'NSLNISP|NMDC Steel|Metal/PSU|NSLNISP.NS\n' +
'NTPC|NTPC|Power|NTPC.NS\n' +
'NTPCGREEN|NTPC Green Energy|Power|NTPCGREEN.NS\n' +
'NUVAMA|Nuvama Wealth Management|Financial Services|NUVAMA.NS\n' +
...
'OIL|Oil India|Oil Gas & Consumable Fuels|OIL.NS\n' +
'OLAELEC|Ola Electric Mobility|EV|OLAELEC.NS\n' +
'OLECTRA|Olectra Greentech|EV/Bus|OLECTRA.NS\n' +
'ONESOURCE|Onesource Specialty Pharma|Healthcare|ONESOURCE.NS\n' +
'ONGC|Oil & Natural Gas Corp|Oil & Gas|ONGC.NS\n' +
'OPTIEMUS|Optiemus Infracom|Telecom|OPTIEMUS.NS\n' +
'ORIENTCEM|Orient Cement|Construction Materials|ORIENTCEM.NS\n' +
'ORKLAINDIA|Orkla India|FMCG|ORKLAINDIA.NS\n' +
'OSWALPUMPS|Oswal Pumps|Capital Goods|OSWALPUMPS.NS\n' +
'PAGEIND|Page Industries|Textile|PAGEIND.NS\n' +
'PARADEEP|Paradeep Phosphates|Chemicals|PARADEEP.NS\n' +
'PARAS|Paras Defence & Space|Defence|PARAS.NS\n' +
'PARKHOSPS|Park Medi World|Healthcare|PARKHOSPS.NS\n' +
'PATANJALI|Patanjali Foods|FMCG|PATANJALI.NS\n' +
'PAYTM|One 97 Communications|Financial Services|PAYTM.NS\n' +
'PCBL|PCBL Chemical|Chemicals|PCBL.NS\n' +
'PCJEWELLER|PC Jeweller|Consumer Durables|PCJEWELLER.NS\n' +
...
'PFOCUS|Prime Focus|Media Entertainment & Publication|PFOCUS.NS\n' +
'PGEL|PG Electroplast|Consumer Durables|PGEL.NS\n' +
'PGHH|P&G Hygiene & Health|FMCG|PGHH.NS\n' +
'PGIL|Pearl Global Industries|Textiles|PGIL.NS\n' +
'PHOENIXLTD|Phoenix Mills|Realty|PHOENIXLTD.NS\n' +
'PICCADIL|Piccadily Agro Industries|FMCG|PICCADIL.NS\n' +
...
'PINELABS|Pine Labs|Financial Services|PINELABS.NS\n' +
'PIRAMALFIN|Piramal Finance|Financial Services|PIRAMALFIN.NS\n' +
'PNB|Punjab National Bank|Banking/PSU|PNB.NS\n' +
'PNBHOUSING|PNB Housing Finance|Housing Finance|PNBHOUSING.NS\n' +
'PNCINFRA|PNC Infratech|Construction|PNCINFRA.NS\n' +
'PNGJL|P N Gadgil Jewellers|Consumer Durables|PNGJL.NS\n' +
...
'POLYMED|Poly Medicure|Medical Devices|POLYMED.NS\n' +
'POONAWALLA|Poonawalla Fincorp|NBFC|POONAWALLA.NS\n' +
'POWERGRID|Power Grid Corp|Power/PSU|POWERGRID.NS\n' +
'POWERINDIA|Hitachi Energy India|Capital Goods|POWERINDIA.NS\n' +
'POWERMECH|Power Mech Projects|Construction|POWERMECH.NS\n' +
'PPLPHARMA|Piramal Pharma|Healthcare|PPLPHARMA.NS\n' +
'PRAJIND|Praj Industries|Capital Goods|PRAJIND.NS\n' +
'PRAXIS|Praxis Home Retail|Retail|PRAXIS.NS\n' +
'PREMIERENE|Premier Energies|Capital Goods|PREMIERENE.NS\n' +
'PRESTIGE|Prestige Estates|Realty|PRESTIGE.NS\n' +
'PRICOLLTD|Pricol|Auto Ancillary|PRICOLLTD.NS\n' +
'PRINCEPIPE|Prince Pipes & Fittings|Plastics|PRINCEPIPE.NS\n' +
'PRIVISCL|Privi Speciality Chemicals|Chemicals|PRIVISCL.NS\n' +
'PRSMJOHNSN|Prism Johnson|Cement|PRSMJOHNSN.NS\n' +
'PRUDENT|Prudent Corporate Advisory Services|Financial Services|PRUDENT.NS\n' +
'PTC|PTC India|Power|PTC.NS\n' +
'PTCIL|PTC Industries|Capital Goods|PTCIL.NS\n' +
'PURVA|Puravankara|Realty|PURVA.NS\n' +
'PVRINOX|PVR INOX|Entertainment|PVRINOX.NS\n' +
'PWL|Physicswallah|Consumer Services|PWL.NS\n' +
'QUESS|Quess Corp|Services|QUESS.NS\n' +
'RADICO|Radico Khaitan|Beverages|RADICO.NS\n' +
'RAILTEL|Railtel Corporation Of India|Telecommunication|RAILTEL.NS\n' +
'RAIN|Rain Industries|Chemicals|RAIN.NS\n' +
'RAINBOW|Rainbow Childrens Medicare|Healthcare|RAINBOW.NS\n' +
'RALLIS|Rallis India|Chemicals|RALLIS.NS\n' +
'RAMCOCEM|The Ramco Cements|Construction Materials|RAMCOCEM.NS\n' +
'RATEGAIN|Rategain Travel Technologies|Information Technology|RATEGAIN.NS\n' +
'RATNAMANI|Ratnamani Metals & Tubes|Capital Goods|RATNAMANI.NS\n' +
'RAYMONDLSL|Raymond Lifestyle|Textiles|RAYMONDLSL.NS\n' +
'RBA|Restaurant Brands Asia|Consumer Services|RBA.NS\n' +
'RBLBANK|RBL Bank|Financial Services|RBLBANK.NS\n' +
'RCF|Rashtriya Chemicals & Fertilizers|Chemicals|RCF.NS\n' +
'RECLTD|REC|NBFC/PSU|RECLTD.NS\n' +
'REDINGTON|Redington|Services|REDINGTON.NS\n' +
'REDTAPE|Redtape|Consumer Durables|REDTAPE.NS\n' +
'REFEX|Refex Industries|Utilities|REFEX.NS\n' +
'RELAXO|Relaxo Footwears|Consumer Durables|RELAXO.NS\n' +
'RELIANCE|Reliance Industries|Energy|RELIANCE.NS\n' +
'RELIGARE|Religare Enterprises|Financial Services|RELIGARE.NS\n' +
'RENUKA|Shree Renuka Sugars|FMCG|RENUKA.NS\n' +
'RHIM|RHI MAGNESITA INDIA|Capital Goods|RHIM.NS\n' +
'RITES|RITES|Infrastructure/PSU|RITES.NS\n' +
'RKFORGE|Ramkrishna Forgings|Automobile & Auto Components|RKFORGE.NS\n' +
'ROUTE|Route Mobile|Telecommunication|ROUTE.NS\n' +
'RPGLIFE|RPG Life Sciences|Pharma|RPGLIFE.NS\n' +
'RPOWER|Reliance Power|Power|RPOWER.NS\n' +
'RRKABEL|R R Kabel|Capital Goods|RRKABEL.NS\n' +
'RTNINDIA|RattanIndia Enterprises|Consumer Services|RTNINDIA.NS\n' +
'RTNPOWER|Rattanindia Power|Power|RTNPOWER.NS\n' +
'RUBICON|Rubicon Research|Healthcare|RUBICON.NS\n' +
'RVNL|Rail Vikas Nigam|Infrastructure/PSU|RVNL.NS\n' +
'SAATVIKGL|Saatvik Green Energy|Capital Goods|SAATVIKGL.NS\n' +
'SAFARI|Safari Industries|Consumer|SAFARI.NS\n' +
'SAGILITY|Sagility|IT|SAGILITY.NS\n' +
'SAIL|Steel Authority of India|Metal/PSU|SAIL.NS\n' +
'SAILIFE|Sai Life Sciences|Healthcare|SAILIFE.NS\n' +
'SAKSOFT|Saksoft|IT|SAKSOFT.NS\n' +
'SAMHI|Samhi Hotels|Consumer Services|SAMHI.NS\n' +
'SAMMAANCAP|Sammaan Capital|Housing Finance|SAMMAANCAP.NS\n' +
'SANDUMA|Sandur Manganese & Iron Ores|Metals & Mining|SANDUMA.NS\n' +
'SANOFI|Sanofi India|Pharma|SANOFI.NS\n' +
'SANOFICONR|Sanofi Consumer Healthcare India|Healthcare|SANOFICONR.NS\n' +
'SANSERA|Sansera Engineering|Automobile & Auto Components|SANSERA.NS\n' +
...
'SBFC|SBFC Finance|Financial Services|SBFC.NS\n' +
...
'SCHAEFFLER|Schaeffler India|Automobile & Auto Components|SCHAEFFLER.NS\n' +
'SCHNEIDER|Schneider Electric Infrastructure|Capital Goods|SCHNEIDER.NS\n' +
'SCI|Shipping Corp of India|Shipping/PSU|SCI.NS\n' +
'SENCO|Senco Gold|Jewellery|SENCO.NS\n' +
'SFL|Sheela Foam|Consumer Durables|SFL.NS\n' +
'SHAILY|Shaily Engineering Plastics|Consumer Durables|SHAILY.NS\n' +
'SHAKTIPUMP|Shakti Pumps (India)|Capital Goods|SHAKTIPUMP.NS\n' +
'SHARDACROP|Sharda Cropchem|Chemicals|SHARDACROP.NS\n' +
'SHARDAMOTR|Sharda Motor Industries|Auto Ancillary|SHARDAMOTR.NS\n' +
'SHAREINDIA|Share India Securities|Broking|SHAREINDIA.NS\n' +
'SHILPAMED|Shilpa Medicare|Healthcare|SHILPAMED.NS\n' +
'SHOPERSTOP|Shoppers Stop|Retail|SHOPERSTOP.NS\n' +
'SHREECEM|Shree Cement|Cement|SHREECEM.NS\n' +
'SHRIPISTON|SPR Auto Technologies|Automobile & Auto Components|SHRIPISTON.NS\n' +
...
'SIGNATURE|Signatureglobal (India)|Realty|SIGNATURE.NS\n' +
'SJVN|SJVN|Power/PSU|SJVN.NS\n' +
'SKFINDIA|SKF India|Automobile & Auto Components|SKFINDIA.NS\n' +
'SKFINDUS|SKF India (Industrial)|Capital Goods|SKFINDUS.NS\n' +
'SKIPPER|Skipper|Electrical|SKIPPER.NS\n' +
'SKYGOLD|Sky Gold and Diamonds|Consumer Durables|SKYGOLD.NS\n' +
'SMARTWORKS|Smartworks Coworking Spaces|Services|SMARTWORKS.NS\n' +
'SMLMAH|SML Mahindra|Auto|SMLMAH.NS\n' +
...
'SONATSOFTW|Sonata Software|IT|SONATSOFTW.NS\n' +
'SOUTHBANK|South Indian Bank|Financial Services|SOUTHBANK.NS\n' +
'SPARC|Sun Pharma Advanced Research|Pharma|SPARC.NS\n' +
'SPLPETRO|Supreme Petrochem|Chemicals|SPLPETRO.NS\n' +
'SRF|SRF|Chemicals|SRF.NS\n' +
'STAR|Strides Pharma Science|Healthcare|STAR.NS\n' +
'STARCEMENT|Star Cement|Cement|STARCEMENT.NS\n' +
'STARHEALTH|Star Health and Allied Insurance Company|Financial Services|STARHEALTH.NS\n' +
'STLTECH|Sterlite Technologies|Telecom Infra|STLTECH.NS\n' +
'STYL|Seshaasai Technologies|Financial Services|STYL.NS\n' +
'STYRENIX|Styrenix Performance Materials|Chemicals|STYRENIX.NS\n' +
'SUBROS|Subros|Auto Ancillary|SUBROS.NS\n' +
'SUDARSCHEM|Sudarshan Chemical Industries|Chemicals|SUDARSCHEM.NS\n' +
'SUDEEPPHRM|Sudeep Pharma|Chemicals|SUDEEPPHRM.NS\n' +
...
'SUNTV|Sun TV Network|Media Entertainment & Publication|SUNTV.NS\n' +
'SUPREMEIND|Supreme Industries|Plastics|SUPREMEIND.NS\n' +
'SUPRIYA|Supriya Lifescience|Healthcare|SUPRIYA.NS\n' +
...
'SUZLON|Suzlon Energy|Capital Goods|SUZLON.NS\n' +
'SWANCORP|Swan Corp|Chemicals|SWANCORP.NS\n' +
'SWIGGY|Swiggy|Consumer Services|SWIGGY.NS\n' +
...
'SYRMA|Syrma SGS Technology|Capital Goods|SYRMA.NS\n' +
'TAKE|Take Solutions|IT|TAKE.NS\n' +
'TANLA|Tanla Platforms|IT|TANLA.NS\n' +
'TARC|TARC|Realty|TARC.NS\n' +
'TARIL|Transformers And Rectifiers (India)|Capital Goods|TARIL.NS\n' +
'TASTYBITE|Tasty Bite Eatables|FMCG|TASTYBITE.NS\n' +
'TATACAP|Tata Capital|Financial Services|TATACAP.NS\n' +
'TATACHEM|Tata Chemicals|Chemicals|TATACHEM.NS\n' +
...
'TATAINVEST|Tata Investment Corporation|Financial Services|TATAINVEST.NS\n' +
'TATAPOWER|Tata Power|Power|TATAPOWER.NS\n' +
'TATASTEEL|Tata Steel|Metal|TATASTEEL.NS\n' +
'TATATECH|Tata Technologies|IT|TATATECH.NS\n' +
'TBOTEK|TBO Tek|Internet|TBOTEK.NS\n' +
'TCS|Tata Consultancy Services|IT|TCS.NS\n' +
'TDPOWERSYS|TD Power Systems|Capital Goods|TDPOWERSYS.NS\n' +
'TECHM|Tech Mahindra|IT|TECHM.NS\n' +
'TECHNOE|Techno Electric & Engineering Company|Construction|TECHNOE.NS\n' +
'TEGA|Tega Industries|Capital Goods|TEGA.NS\n' +
'TEJASNET|Tejas Networks|Telecommunication|TEJASNET.NS\n' +
'TENNIND|Tenneco Clean Air India|Automobile & Auto Components|TENNIND.NS\n' +
'TEXRAIL|Texmaco Rail & Eng.|Capital Goods|TEXRAIL.NS\n' +
'THANGAMAYL|Thangamayil Jewellery|Jewellery|THANGAMAYL.NS\n' +
'THELEELA|Leela Palaces Hotels & Resorts|Consumer Services|THELEELA.NS\n' +
'THERMAX|Thermax|Industrial|THERMAX.NS\n' +
'THOMASCOOK|Thomas Cook (India)|Consumer Services|THOMASCOOK.NS\n' +
'THYROCARE|Thyrocare Technologies|Diagnostics|THYROCARE.NS\n' +
'TI|Tilaknagar Industries|FMCG|TI.NS\n' +
'TIINDIA|Tube Investments of India|Auto Ancillary|TIINDIA.NS\n' +
'TIMETECHNO|Time Technoplast|Plastics|TIMETECHNO.NS\n' +
'TIMKEN|Timken India|Capital Goods|TIMKEN.NS\n' +
'TIPSMUSIC|Tips Music|Media|TIPSMUSIC.NS\n' +
'TITAGARH|Titagarh Rail Systems|Capital Goods|TITAGARH.NS\n' +
'TITAN|Titan Company|Consumer|TITAN.NS\n' +
'TMB|Tamilnad Mercantile Bank|Financial Services|TMB.NS\n' +
'TMCV|Tata Motors|Capital Goods|TMCV.NS\n' +
'TMPV|Tata Motors Passenger Vehicles|Automobile & Auto Components|TMPV.NS\n' +
'TORNTPHARM|Torrent Pharmaceuticals|Pharma|TORNTPHARM.NS\n' +
'TORNTPOWER|Torrent Power|Power|TORNTPOWER.NS\n' +
'TRANSRAILL|Transrail Lighting|Capital Goods|TRANSRAILL.NS\n' +
'TRAVELFOOD|Travel Food Services|Consumer Services|TRAVELFOOD.NS\n' +
'TRENT|Trent|Retail|TRENT.NS\n' +
'TRIDENT|Trident|Textile|TRIDENT.NS\n' +
'TRITURBINE|Triveni Turbine|Capital Goods|TRITURBINE.NS\n' +
'TSFINV|TSF Investments|Financial Services|TSFINV.NS\n' +
...
'UBL|United Breweries|FMCG|UBL.NS\n' +
...
'URBANCO|Urban Company|Consumer Services|URBANCO.NS\n' +
'USHAMART|Usha Martin|Capital Goods|USHAMART.NS\n' +
'UTIAMC|UTI AMC|Asset Management|UTIAMC.NS\n' +
'UTLSOLAR|Fujiyama Power Systems|Capital Goods|UTLSOLAR.NS\n' +
'V2RETAIL|V2 Retail|Consumer Services|V2RETAIL.NS\n' +
'VAIBHAVGBL|Vaibhav Global|Retail/Gems|VAIBHAVGBL.NS\n' +
'VARROC|Varroc Engineering|Automobile & Auto Components|VARROC.NS\n' +
...
'VIKRAMSOLR|Vikram Solar|Capital Goods|VIKRAMSOLR.NS\n' +
'VIPIND|V.I.P. Industries|Consumer Durables|VIPIND.NS\n' +
'VIYASH|Viyash Scientific|Healthcare|VIYASH.NS\n' +
'VMART|V-Mart Retail|Consumer Services|VMART.NS\n' +
'VMM|Vishal Mega Mart|Consumer Services|VMM.NS\n' +
'VOLTAMP|Voltamp Transformers|Capital Goods|VOLTAMP.NS\n' +
...
'VTL|Vardhman Textiles|Textiles|VTL.NS\n' +
'WAAREEENER|Waaree Energies|Capital Goods|WAAREEENER.NS\n' +
'WAAREERTL|Waaree Renewable Technologies|Capital Goods|WAAREERTL.NS\n' +
'WABAG|VA Tech Wabag|Infrastructure|WABAG.NS\n' +
'WAKEFIT|Wakefit Innovations|Consumer Durables|WAKEFIT.NS\n' +
'WEBELSOLAR|Websol Energy System|Capital Goods|WEBELSOLAR.NS\n' +
'WELCORP|Welspun Corp|Metal|WELCORP.NS\n' +
'WELENT|Welspun Enterprises|Construction|WELENT.NS\n' +
'WELSPUNLIV|Welspun Living|Textile|WELSPUNLIV.NS\n' +
'WENDT|Wendt (India)|Industrial|WENDT.NS\n' +
'WESTLIFE|Westlife Foodworld|Consumer Services|WESTLIFE.NS\n' +
'WEWORK|WeWork India Management|Services|WEWORK.NS\n' +
'WHIRLPOOL|Whirlpool of India|Consumer Durables|WHIRLPOOL.NS\n' +
'WIPRO|Wipro|IT|WIPRO.NS\n' +
'WOCKPHARMA|Wockhardt|Healthcare|WOCKPHARMA.NS\n' +
'XCHANGING|Xchanging Solutions|IT|XCHANGING.NS\n' +
'YATHARTH|Yatharth Hospital & Trauma Care Services|Healthcare|YATHARTH.NS\n' +
'YESBANK|Yes Bank|Banking|YESBANK.NS\n' +
'ZAGGLE|Zaggle Prepaid Ocean Services|Information Technology|ZAGGLE.NS\n' +
...
'ZFCVINDIA|ZF Commercial Vehicle Control Systems India|Automobile & Auto Components|ZFCVINDIA.NS\n' +
'ZYDUSLIFE|Zydus Lifesciences|Pharma|ZYDUSLIFE.NS\n' +
'ZYDUSWELL|Zydus Wellness|FMCG|ZYDUSWELL.NS';
